...
const routes: Routes = [
...

  {
    ...
    canActivate: [AuthGuard],
    loadChildren: () =>
      loadRemoteModule({ type: 'module', remoteEntry: 'http://localhost:4212/remoteEntry.js', exposedModule: './Routes' })
        .then((m: any) => m.remoteRoutes).catch(portalFallback),
  },

  {
    ...
    canActivate: [AuthGuard],
    loadChildren: () =>
      loadRemoteModule({ type: 'module', remoteEntry: 'http://localhost:4213/remoteEntry.js', exposedModule: './Routes' })
        .then((m: any) => m.remoteRoutes).catch(portalFallback),
  },
...

  {
    ...
    loadChildren: () =>
      loadRemoteModule({ type: 'module', remoteEntry: 'http://localhost:4203/remoteEntry.js', exposedModule: './Module' })
        .then((m: any) => m.BtaRemoteEntryModule).catch(portalFallback),
  },

  {
    ...
    loadChildren: () =>
      loadRemoteModule({ type: 'module', remoteEntry: 'http://localhost:4204/remoteEntry.js', exposedModule: './Module' })
        .then((m: any) => m.OffersRemoteEntryModule).catch(portalFallback),
  },

  {
    ...
    loadChildren: () =>
      loadRemoteModule({ type: 'module', remoteEntry: 'http://localhost:4205/remoteEntry.js', exposedModule: './Module' })
        .then((m: any) => m.SuppRemoteEntryModule).catch(portalFallback),
  },

  {
    ...
    loadChildren: () =>
      loadRemoteModule({ type: 'module', remoteEntry: 'http://localhost:4206/remoteEntry.js', exposedModule: './Module' })
        .then((m: any) => m.WearablesRemoteEntryModule).catch(portalFallback),
  },

  {
    ...
    loadChildren: () =>
      loadRemoteModule({ type: 'module', remoteEntry: 'http://localhost:4207/remoteEntry.js', exposedModule: './Module' })
        .then((m: any) => m.PayWithPointsModule).catch(portalFallback),
  },

  {
    ...
    loadChildren: () =>
      loadRemoteModule({ type: 'module', remoteEntry: 'http://localhost:4209/remoteEntry.js', exposedModule: './Module' })
        .then((m: any) => m.LoungeRemoteEntryModule).catch(portalFallback),
  },
...

  {
    ...
    loadChildren: () =>
      loadRemoteModule({ type: 'module', remoteEntry: 'http://localhost:4211/remoteEntry.js', exposedModule: './Module' })
        .then((m: any) => m.CenturionRemoteEntryModule).catch(portalFallback),
  },

  {
    ...
    loadChildren: () =>
      loadRemoteModule({ type: 'module', remoteEntry: 'http://localhost:4210/remoteEntry.js', exposedModule: './Module' })
        .then((m: any) => m.CenLcyExcRemoteEntryModule).catch(portalFallback),
  },
