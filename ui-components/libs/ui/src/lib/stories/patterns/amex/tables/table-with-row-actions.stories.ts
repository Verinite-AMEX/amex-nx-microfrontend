...
import { AmexTableWithRowActionsComponent } from '../../../../patterns/amex/tables/table-with-row-actions';

const meta: Meta<AmexTableWithRowActionsComponent> = {
  title: 'Patterns/Amex/Tables/TableWithRowActions',
  component: AmexTableWithRowActionsComponent,
  argTypes: {
    showPagination: { control: 'boolean' },
    currentPage: { control: 'object' },
    totalPages: { control: 'object' },
  },
  tags: ['autodocs'],
};
export default meta;
