...
import { AmexSOCROCRecordsTableComponent } from '../../../../patterns/amex/tables/socroc-records-table';

const meta: Meta<AmexSOCROCRecordsTableComponent> = {
  title: 'Patterns/Amex/Tables/SOCROCRecordsTable',
  component: AmexSOCROCRecordsTableComponent,
  argTypes: {
    rows: { control: 'object' },
    sectionLabel: { control: 'object' },
