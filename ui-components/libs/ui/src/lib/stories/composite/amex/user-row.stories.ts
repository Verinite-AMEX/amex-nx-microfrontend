...
import { AmexUserRowComponent } from '../../../composite/amex/user-row';

const meta: Meta<AmexUserRowComponent> = {
  title: 'Composite/Amex/UserRow',
  ...
  argTypes: {
    ...
    showResetPassword: { control: 'boolean' },
    showToggleStatus: { control: 'boolean' },
    editLabel: { control: 'text' },
    resetPasswordLabel: { control: 'text' },
    lockLabel: { control: 'text' },
    unlockLabel: { control: 'text' },
    editVariant: { control: 'text' },
    resetPasswordVariant: { control: 'text' },
    lockVariant: { control: 'text' },
    unlockVariant: { control: 'text' },
    buttonSize: { control: 'text' },
    editAriaLabel: { control: 'text' },
    resetPasswordAriaLabel: { control: 'text' },
    lockAriaLabel: { control: 'text' },
    unlockAriaLabel: { control: 'text' },
    roleLabels: { control: 'text' },
  },
  decorators: [
