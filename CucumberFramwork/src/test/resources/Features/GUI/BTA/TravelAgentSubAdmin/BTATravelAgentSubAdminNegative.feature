@UI @BTA @TravelAgentSubAdmin

Feature: Verify that the Travel Agent Sub Admin can successfully access the BTA portal,
  navigate to all available sections,and validate their functionality.

  Background:
    Given Navigate to the BTA Portal
    When I enter username "ta.sub.admin" and password "Travel@1234"
  ...
  @TravelAgentSubAdmin_001 @Sanity
  Scenario: Verify BTA functionality for Travel Agent Sub Admin User
#        User Management
